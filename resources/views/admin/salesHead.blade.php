    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/admin/person">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/admin/allcustomers">
              <span class="menu-icon">
                        ...
                        <tbody>
                          ...
                          @foreach ($salesHead as $data)
                            <tr>
                                ...
                                <td><a class="btn btn-outline-primary" href="/admin/sales-head/{{$data->userID}}/sales-person">details</a></td>
                            </tr>
                          @endforeach
                        </tbody>
                      </table>
