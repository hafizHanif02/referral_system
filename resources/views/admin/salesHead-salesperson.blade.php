    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                ">
                                        <h4 class="card-title">Sales Head</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $salesHead['name'] }}"
                                                            class="form-control text-dark" readonly>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="text-white">Status</label>
                                                        @if ($salesHead['isActive'])
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="s_name"
                                                            value="{{ $salesHead['email'] }}"
                                                            class="form-control text-dark" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="text-white">Phone</label>
                                                        <input type="text" value="{{ $salesHead['phone'] }}"
                                                            class="form-control text-dark" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="text-white">Referral Code</label>
                                                        <input type="text" value="{{ $salesHead['refCode'] }}"
                                                            class="form-control text-dark" readonly>
                                                    </div>
                                    ...
                                    <div class=" d-flex justify-content-between">
                                        ...
                                        <a href="/admin/sales-head/{{ $salesHead['id'] }}/sales-person/new"
                                            class="nav-link btn btn-success create-new-button">+ Add new</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-outline-primary"
                                                                href="/admin/sales-person/{{ $person->id }}/customer">details</a>
                                                        </td>
